...
Before applying rules from this skill, check if `.claude/overrides/tech-drizzle.md` exists.
...
When creating the override file, use this content:
    ...
    # Tech Drizzle — Project Overrides
    #
    # This file customizes the upstream tech-drizzle skill for this project.
