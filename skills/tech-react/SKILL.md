...
Before applying rules from this skill, check if `.claude/overrides/tech-react.md` exists.
...
When creating the override file, use this content:
    ...
    # Tech React — Project Overrides
    #
    # This file customizes the upstream tech-react skill for this project.
