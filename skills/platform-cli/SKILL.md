...
Before applying rules from this skill, check if `.claude/overrides/platform-cli.md` exists.
...
When creating the override file, use this content:
    ...
    # Platform Cli — Project Overrides
    #
    # This file customizes the upstream platform-cli skill for this project.
