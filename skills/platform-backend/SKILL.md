...
Before applying rules from this skill, check if `.claude/overrides/platform-backend.md` exists.
...
When creating the override file, use this content:
    ...
    # Platform Backend — Project Overrides
    #
    # This file customizes the upstream platform-backend skill for this project.
