...
Before applying rules from this skill, check if `.claude/overrides/agent-skill-creator.md` exists.
...
When creating the override file, use this content:
    ...
    # Agent Skill Creator — Project Overrides
    #
    # This file customizes the upstream agent-skill-creator skill for this project.
