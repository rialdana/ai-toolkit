...
Before applying rules from this skill, check if `.claude/overrides/promptify.md` exists.
...
When creating the override file, use this content:
    ...
    # Promptify — Project Overrides
    #
    # This file customizes the upstream promptify skill for this project.
