...
Before applying rules from this skill, check if `.claude/overrides/tech-trpc.md` exists.
...
When creating the override file, use this content:
    ...
    # Tech Trpc — Project Overrides
    #
    # This file customizes the upstream tech-trpc skill for this project.
