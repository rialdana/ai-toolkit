...
Before applying rules from this skill, check if `.claude/overrides/liquid-glass-ios.md` exists.
...
When creating the override file, use this content:
    ...
    # Liquid Glass Ios — Project Overrides
    #
    # This file customizes the upstream liquid-glass-ios skill for this project.
